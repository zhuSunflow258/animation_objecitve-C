...
- (id)init
{
    ...
    if (self) {
        ...
        NSMutableArray *jazzArray = [NSMutableArray array];
        for (int i = 1; i <= 2; i++) {
            [jazzArray addObject:[NSString stringWithFormat:@"jazz%i.png",i]];
        }
        self = [self initWithImageNameArray:jazzArray];
