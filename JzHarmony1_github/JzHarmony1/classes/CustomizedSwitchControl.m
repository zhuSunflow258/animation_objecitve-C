...
static const CGFloat ZhuSwitchAnimationDuration = 0.25;

@interface  CustomizedSwitchControl()
...
@implementation CustomizedSwitchControl
...
- (void)updateThumbPositionAnimated:(BOOL)animated
{
    ...
    if (animated) {
        ...
        CGFloat animationDuration = ZhuSwitchAnimationDuration * distanceOfTravel;
